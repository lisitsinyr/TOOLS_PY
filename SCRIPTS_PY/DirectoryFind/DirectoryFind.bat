...
:begin
    ...
    set A1_Name=search_path
    set A1_Caption=search_path
    ...
    set A2_Name=directory_name
    set A2_Caption=directory_name
    set A2_Default=
    set A2=!A2_Default!
    ...
    python "!SCRIPTS_DIR_PY!"\SRC\DirectoryFind\DirectoryFind.py !OPTION! !ARGS!
