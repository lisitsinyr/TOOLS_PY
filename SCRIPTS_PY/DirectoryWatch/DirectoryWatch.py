...
# БИБЛИОТЕКА lyrpy
#------------------------------------------
# import python-directory-watch as w
...
#beginfunction
    ...
    # 
    #--------------------------------------------------------------
    Ltest_dir = r'D:\PROJECTS_LYR\CHECK_LIST\DESKTOP\Python\PROJECTS_PY\SCRIPTS_PY\SRC\00.TEST\DirectoryWatch\test_dir'
    for new_file_path in listen(Path(Ltest_dir),  pattern ="*.txt"):
        try:
